...
library(gmodels)
g1 <- ggplot(alc, aes(x = higher, y = alc_use))
g1 <- ggplot(alc, aes(x = higher, y = alc_use, col = sex))
g1 + geom_boxplot()

```

In order to, to learn how to read a boxplot, you can follow [this link](www.physics.csbsju.edu/stats/box2.html).
...
The plot displays fairly interesting observations. On the right side of the plot the respondents with intentions for a higher educational degree and their respective alcohol-consumption levels. 
