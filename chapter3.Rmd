...
...**"alc_use"**, which displays the average-answers related to weekday and weekend alcohol consumption. For a brief glimpse at the respective variable, see the summary here:

```{r summary_alc$alc_use}
