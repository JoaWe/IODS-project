...
1. choosing the number of clusters and picking the initial cluster-centroids (meaning "the central point of each cluster"), by means of the "total within the cluster sum of squares" (abbreviated with "twcss" in the code)
...
Steps 4. and 5. are undertaken until no further changes of centroids and clusters occur.
```{r k-means of Boston}
