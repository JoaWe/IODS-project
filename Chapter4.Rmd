...
3. A categorical variable - named "crime" will be created, with its aid train- and test-sets will be created.
...
The variable **crim** will be of particular importance in the next steps of this exercise.
