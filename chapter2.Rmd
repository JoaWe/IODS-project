...
**"Attitude"** reflects the respondent's general attitude towards statistics. 
...
**"deep", "surf", and "stra"**  are combination variables, the respondents answers are represented within a scale from 1 to 5:
  ...
  - **"stra"** is a combination-variable set up out of the mean ofthe answers given to 8 questions relating to the respondent's organization habits with regard to their studies.

**"Points"** is a variable relating to the respondent's exam-points. The original scale of this variable ranged from 0 to 33. Respondents with 0 exam-points have been excluded from the data-set.
